...
class _$SignInFormEventTearOff {
  ...
  RegisterWithCredentialsPressed registerWithCredentials() {
    return const RegisterWithCredentialsPressed();
  }

  SignInWithCredentialsPressed signInWithCredentials() {
    return const SignInWithCredentialsPressed();
  }

  SignInWithGooglePressed signInWithGoogle() {
...
abstract class RegisterWithCredentialsPressed implements SignInFormEvent {
...
class _$SignInWithCredentialsPressed implements SignInWithCredentialsPressed {
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SignInWithCredentialsPressed);
  }
